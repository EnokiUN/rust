ast_lowering_generic_type_with_parentheses =
    ...
    .wabew = onwy `Fn` twaits may uwse pawentheses
...
ast_lowering_underscore_expr_lhs_assign =
    ...
    .wabew = `_` not awwowed hewe

ast_lowering_base_expression_double_dot =
    base expwession wequwiwed aftew `..`
    .wabew = add a base expwession hewe

ast_lowering_await_only_in_async_fn_and_blocks =
    `owoait` is onwy awwowed inside `ashync` fuwnctions and bwocks
    .wabew = onwy awwowed inside `ashync` fuwnctions and bwocks
...
ast_lowering_async_non_move_closure_not_supported =
    ...
    .hewp = considew uwsing `wet` statements to manuwawwy captuwwe vawiabwes by wefewence befowe entewing an `ashync move` cwosuwwe

ast_lowering_functional_record_update_destructuring_assignment =
    fuwnctionaw wecowd uwpdates awe not awwowed in destwuwctuwwing assignments
    .suwggestion = considew wemoving the twaiwing pattewn
...
ast_lowering_abi_specified_multiple_times =
    ...
    .wabew = pweviouwswy specified hewe
...
ast_lowering_register_conflict =
    ...
    .hewp = uwse `wateouwt` instead of `ouwt` to avoid confwict
...
ast_lowering_sub_tuple_binding =
    ...
    .wabew = this is onwy awwowed in swice pattewns
    .hewp = wemove this and bind each tuwpwe fiewd independentwy

ast_lowering_sub_tuple_binding_suggestion =
    if u don't need to uwse the contents of {$ident}, discawd the tuwpwe's wemaining fiewds

ast_lowering_extra_double_dot =
    `..` can onwy be uwsed once pew {$ctx} pattewn
    .wabew = can onwy be uwsed once pew {$ctx} pattewn
...
ast_lowering_trait_fn_async =
    ...
    .wabew = `ashync` becauwse of thwish
